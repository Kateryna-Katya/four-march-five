    ...
    <section class="pages">
        <div class="container">
            ...
            <p data-aos="fade-up" data-aos-delay="100">
                Добро пожаловать на платформу <strong><?= $domainTitle ?></strong>! Чтобы обеспечить 
                вам доступ к передовой цифровой инфраструктуре, персонализировать ваш путь и 
                анализировать эффективность наших стратегий, мы используем файлы cookie. 
                Настоящая политика объясняет, как технологии нового поколения работают на вашем устройстве.
            </p>

            <h2 data-aos="fade-up">Что такое файлы cookie?</h2>
            <p data-aos="fade-up">
                Файл cookie — это небольшой фрагмент данных, который <strong><?= $domainTitle ?></strong> 
                сохраняет на вашем устройстве. Это позволяет нам "помнить" ваши предпочтения 
                (например, язык, настройки региона <strong>Италия</strong> и параметры блога) 
                в течение определенного времени, чтобы ваш карьерный апгрейд проходил максимально гладко 
                и без лишних повторных настроек.
            </p>
            ...
            <ul>
                <li data-aos="fade-left" data-aos-delay="100">
                    <strong>Строго необходимые:</strong> Критически важны для работы платформы. Позволяют безопасно использовать базовые возможности и AI-инструменты.
                </li>
                <li data-aos="fade-left" data-aos-delay="200">
                    <strong>Аналитические:</strong> Помогают нам оценивать перспективы проекта и понимать, какой контент блога приносит вам больше пользы.
                </li>
                <li data-aos="fade-left" data-aos-delay="300">
                    <strong>Функциональные:</strong> Запоминают ваш выбор для предоставления экспертной поддержки в персонализированном формате.
                </li>
                <li data-aos="fade-left" data-aos-delay="400">
                    <strong>Маркетинговые:</strong> Используются для доставки релевантных решений, которые меняют правила игры в вашей карьере.
                </li>
            </ul>
            ...
            <ul>
                <li data-aos="fade-up">Обеспечение стабильной работы решений, применимых уже сегодня.</li>
                <li data-aos="fade-up">Анализ поведения для оптимизации пути к вашему Job Offer в Европе.</li>
                <li data-aos="fade-up">Персонализация стратегий роста на базе инноваций.</li>
            </ul>

            <h2 data-aos="fade-up">Ваш выбор и управление</h2>
            <p data-aos="fade-up">
                Вы имеете полный контроль. Настройки можно изменить в браузере в любой момент. 
                Помните, что ограничение cookie может замедлить ваш быстрый и легкий старт 
                на нашей платформе.
            </p>

            <h2 data-aos="fade-up">Сторонние сервисы</h2>
            <p data-aos="fade-up">
                На страницах <strong><?= $domainTitle ?></strong> могут использоваться скрипты Google Analytics 
                или библиотеки визуализации (например, Anime.js). Мы рекомендуем ознакомиться 
                с их политиками конфиденциальности для полной прозрачности.
            </p>

            <h2 data-aos="fade-up">Контактная информация</h2>
            <p data-aos="fade-up">
                Если у вас возникли вопросы касательно технологий на сайте <strong><?= $domainTitle ?></strong>, 
                мы всегда на связи:
                <br><br>
